...
namespace DAO
{
    public class ThuTienNhaDAO
    {
        ...
        public bool InsertThuTienNha(string maSoThu, string maSoThue, string thang, string nam, decimal tongTien, string nguoiThu, DateTime ngayThu, string ghiChu)
        {
            try
            {
                Instance.ExecuteNonQuery($"INSERT ThuTienNha (MaSoThu, MaSoThue, Thang, Nam, TongTien, NguoiThu, NgayThu, GhiChu)" + $"VALUES (N'{maSoThu}', N'{maSoThue}', N'{maSoThue}', N'{thang}', N'{nam}', {tongTien}, N'{ngayThu}' ,N'{ghiChu}')");
            }
            catch
            {
                return false;
